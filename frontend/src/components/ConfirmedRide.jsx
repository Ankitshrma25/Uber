  ...
  return (
    <div>
      <h5 onClick={()=>{
        ...
        <div>
            <h3 className='text-sm font-medium'>60/171</h3>
            <p className='text-base text-gray-600'>Khwas Pura Kheria Mod, Agra, Uttar Pradesh</p>
        </div>
        </div>
        <div></div>
        <div></div>
        </div>
        <button className='w-full bg-green-600 text-white p-2 rounded-lg'>Confirm</button>
        </div>
    </div>
  )
}
