...
const FinishRide = (props) => {
  return (
    <div>
      ...
      <div className='flex gap-5 items-center justify-between p-4 mt-4 border-2 border-yellow-400 rounded-lg'>
      ...
      <div className='flex gap-2 flex-col border-2 border-gray-50 rounded-xl items-center justify-between '>
        ...
        <div className='mt-6 w-full'>
          ...
          <Link to='/captain-home' className='flex items-center text-lg justify-center w-full mt-5 bg-green-600 text-white p-3 rounded-lg'>Finish Ride</Link>
